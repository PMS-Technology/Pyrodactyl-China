            ...
            <div className='flex flex-wrap gap-4'>
                ...
                >
                    <Can action={'modrinth.loader'}>
                        <ModBox>
                            <ContentBox title='加载器' className=''>
                                <LoaderSelector
                    ...
                    <Can action={'modrinth.version'}>
                        <ModBox>
                            <ContentBox title='版本' className='scrollbar-thumb-red-700'>
                                <GameVersionSelector
                                    appVersion={appVersion}
                                    baseUrl={url}

        ...
        <PageContentBlock title={'Dashboard'} showFlashKey={'dashboard'}>
            <div className='w-full h-full min-h-full flex-1 flex flex-col px-2 sm:px-0'>
                ...
                >
                    ...
                    >
                        <MainPageHeader
                            title={showOnlyAdmin ? '其他服务器' : '我的服务器'}
                            titleChildren={
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent className='flex flex-col gap-1 z-99999' sideOffset={8}>
                                            ...
                                            {rootAdmin && (
                                                ...
                                                >
                                                    {showOnlyAdmin ? '显示个人服务器' : '显示其他服务器'}
                                                </DropdownMenuItem>
                                            )}
                                        </DropdownMenuContent>
                                    </DropdownMenu>
                                    <TabsList>
                                        <TabsTrigger aria-label='以列表布局查看服务器' value='list'>
                                            <svg
                                                width='16'
                                                height='17'
                                                viewBox='0 0 16 17'
                                        ...
                                        <TabsTrigger aria-label='以网格布局查看服务器' value='grid'>
                                            <svg
                                                width='16'
                                                height='17'
                                                viewBox='0 0 16 17'

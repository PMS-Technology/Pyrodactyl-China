        ...
        <PageContentBlock title={'您的设置'}>
            <div className='w-full h-full min-h-full flex-1 flex flex-col px-2 sm:px-0'>
                {state?.twoFactorRedirect && (
                    ...
                    >
                        <MessageBox title={'需要双重验证'} type={'error'}>
                            您的账户必须启用双重身份验证才能继续。
                        </MessageBox>
                    </div>
                )}
                ...
                <div className='flex flex-col w-full h-full gap-4'>
                    ...
                    >
                        <ContentBox title={'账户邮箱'} showFlashes={'account:email'}>
                    ...
                    >
                        <ContentBox title={'面板版本'}>
                            <p className='text-sm mb-4 text-zinc-300'>
                                如果您遇到意外问题，向Pyro工作人员提供此信息会很有用。
                            </p>
                            <div className='flex flex-col gap-4'>
                                <Code>
                                    版本: {import.meta.env.VITE_PYRODACTYL_VERSION} -{' '}

                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>这应该是一个描述性类别名称，涵盖服务内的所有选项。</small></p>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">用于内部和通过 API 识别此预设组的唯一 ID。</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">此服务选项的作者。除非这是由 <code>support@pterodactyl.io</code> 创作的官方选项，否则请将问题和疑问直接向他们提出。</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">所有使用此选项的服务器都被分配的 UUID，用于识别目的。</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-footer">
                <a href="{{ route('admin.nests.egg.new') }}"><button class="btn btn-success btn-sm pull-right">新建预设</button></a>
            </div>
        </div>
    </div>
</div>

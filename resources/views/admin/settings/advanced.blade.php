...
@section('content-header')
  <h1>高级设置<small>配置 Pterodactyl 的高级设置。</small></h1>
  <ol class="breadcrumb">
    ...
    <form action="" method="POST">
      ...
      <div class="box-body">
        ...
        <div class="form-group col-md-6">
          ...
          <p class="text-muted small">在抛出错误之前等待连接打开的秒数。</p>
          </div>
        </div>
        <div class="form-group col-md-6">
          ...
          <p class="text-muted small">在抛出错误之前等待请求完成的秒数。</p>
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="box-body">
        ...
        <div class="form-group col-md-4">
          ...
          <p class="text-muted small">可以自动分配的范围内的起始端口。</p>
          </div>
        </div>
        <div class="form-group col-md-4">
          ...
          <p class="text-muted small">可以自动分配的范围内的结束端口。</p>
          </div>
        </div>
        </div>
      </div>

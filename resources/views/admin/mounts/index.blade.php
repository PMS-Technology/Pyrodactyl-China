...
@section('content-header')
    <h1>挂载点<small>配置和管理服务器的附加挂载点。</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">管理员</a></li>
        <li class="active">挂载点</li>
    </ol>
@endsection
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#newMountModal">创建新的</button>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">用于区分此挂载点与其他挂载点的唯一名称。</p>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">此挂载点的详细描述，必须少于191个字符。</p>
                            </div>

                            <div class="col-md-6">
                                <label for="pSource" class="form-label">源路径</label>
                                <input type="text" id="pSource" name="source" class="form-control" />
                                <p class="text-muted small">主机系统上要挂载到容器的文件路径。</p>
                            </div>

                            <div class="col-md-6">
                                <label for="pTarget" class="form-label">目标路径</label>
                                <input type="text" id="pTarget" name="target" class="form-control" />
                                <p class="text-muted small">挂载点在容器内的访问路径。</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">容器内挂载点是否为只读？</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">用户是否可以自己挂载此挂载点？</p>
                            </div>
                        </div>
                    </div>
